...
void LeftSideBar::addTypeButton(QGroupBox* groupbox, QButtonGroup* buttonGroup, const QString& title, bool selected)
{
...
void LeftSideBar::buildTypeGroupBox()
{
    ...
    connect(buttonGroup, SIGNAL(buttonClicked(QAbstractButton*)), this, SLOT(typeClicked(QAbstractButton*)));
