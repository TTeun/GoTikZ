...
QT_MOC_LITERAL(1, 12, 12), // "colorUpdated"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 5), // "color"
QT_MOC_LITERAL(4, 32, 8) // "getColor"

    },
    "ColorWidget\0colorUpdated\0\0color\0"
    "getColor"
};
...
void ColorWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->colorUpdated((*reinterpret_cast< QColor(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ColorWidget::colorUpdated)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ColorWidget::colorUpdated(QColor _t1)
{
