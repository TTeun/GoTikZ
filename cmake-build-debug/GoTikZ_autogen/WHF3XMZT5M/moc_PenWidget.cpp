...
QT_MOC_LITERAL(1, 10, 8), // "setColor"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 5) // "color"

    },
    "PenWidget\0setColor\0\0color"
};
...
void PenWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PenWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject PenWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<ActionWidget::staticMetaObject>(),
    qt_meta_stringdata_PenWidget.data,
    qt_meta_data_PenWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *PenWidget::qt_metacast(const char *_clname)
{
    ...
    return ActionWidget::qt_metacast(_clname);
}

int PenWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = ActionWidget::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)
